            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">
                        <img src="static/images/main-brand.png" alt="" class="brand">
                    </a>
                </div>
                        ...
                        <li class="profile">
                            <span class="wrap">
                                ...
                                <span class="image bg-white">
                                    ...
                                    <!--img src="static/images/profile/profile-img.jpg" alt=""-->
                                </span>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <div class="wrap">
                                        ...
                                        <!-- Image -->
                                        <div class="image">
                                            <img src="static/images/shop/img-01.jpg" alt="">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="footer-brand">
                                            <img src="static/images/main-brand.png" alt="">
                                        </div>
